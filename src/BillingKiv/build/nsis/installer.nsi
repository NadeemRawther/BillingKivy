!define PRODUCT_NAME "BillingKiv"
!define PRODUCT_VERSION "1.0"
!define PY_VERSION "3.6.3"
!define PY_MAJOR_VERSION "3.6"
!define BITNESS "32"
!define ARCH_TAG ""
!define INSTALLER_NAME "BillingKiv_1.0.exe"
...
!define MULTIUSER_INSTALLMODE_INSTDIR "BillingKiv"
...
Section "!${PRODUCT_NAME}" sec_app
  ...
  SetOutPath "%HOMEDRIVE%\%HOMEPATH%"
    CreateShortCut "$SMPROGRAMS\BillingKiv.lnk" "$INSTDIR\Python\pythonw.exe" \
      '"$INSTDIR\BillingKiv.launch.pyw"' "$INSTDIR\myapp.ico"
  SetOutPath "$INSTDIR"
...
Section "Uninstall"
  ...
  ; Uninstall files
    ...
    Delete "$INSTDIR\BillingKiv.launch.pyw"
  ; Uninstall directories
    RMDir /r "$INSTDIR\Python"

  ; Uninstall shortcuts
      Delete "$SMPROGRAMS\BillingKiv.lnk"
  RMDir $INSTDIR
